...
import { Loader2, Mic, MicOff, Video, VideoOff, Volume2, PhoneOff, Users, Monitor, MonitorOff, Headphones, ScreenShare } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        {!isConnected ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-[#6b7387] mb-6">
